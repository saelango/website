...
export class ColorController extends Controller {
    ...
    $disable: HTMLInputElement;
    reset(): ColorController;
    _setValueFromHexString(value: any): void;
    save(): string | false;
    load(value: any): ColorController;
    updateDisplay(): ColorController;
}
/**
 * lil-gui
...
export class NumberController extends Controller {
    ...
    decimals(decimals: any): NumberController;
    _decimals: any;
    min(min: any): NumberController;
    _min: any;
    max(max: any): NumberController;
    _max: any;
    step(step: any, explicit?: boolean): NumberController;
    _step: any;
    _stepExplicit: boolean;
    updateDisplay(): NumberController;
    _initInput(): void;
    $input: HTMLInputElement;
...
export class OptionController extends Controller {
    ...
    updateDisplay(): OptionController;
}
export class StringController extends Controller {
    constructor(parent: any, object: any, property: any);
    $input: HTMLInputElement;
    $disable: HTMLInputElement;
    updateDisplay(): StringController;
}
